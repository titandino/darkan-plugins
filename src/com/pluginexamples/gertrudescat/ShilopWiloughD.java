package com.pluginexamples.gertrudescat;
...
public class ShilopWiloughD extends Conversation {
	...
	public ShilopWiloughD(Player player, NPC npc) {
		...
		if (player.getQuestManager().getStage(Quest.GERTRUDES_CAT) == 0) {
			...
			Dialogue options = addOption(DEFAULT_OPTIONS_TITLE, "Tell me sonny, or I will inform your mum you are a criminal.", "What will make you tell me?", "Well never mind, it's Fluffs' loss.");
			
			options.addPlayer(HeadE.ANGRY, "Tell me sonny, or I will inform your mum you are a criminal.")
			...
			Dialogue payOptions = options.addPlayer(HeadE.CONFUSED, "What will make you tell me?")
			...
			.addOption(DEFAULT_OPTIONS_TITLE, "I'm not paying you a thing.", "Okay then, I'll pay.");			
			
			payOptions.addPlayer(HeadE.ANGRY, "I'm not paying you a thing.")
			...
			if (player.getInventory().containsItem(995, 100)) {
				payOptions.addPlayer(HeadE.NO_EXPRESSION, "Okay then, I'll pay, but I'll want you to tell your mother what a nice person I am.")
				...
				.addNPC(npcId, HeadE.CHILD_CALM_TALK, "It's a deal.")
				.addItem(997, "You give the lad 100 coins.", () -> {
					if (player.getInventory().containsItem(995, 100)) {
				...
				payOptions.addPlayer(HeadE.NO_EXPRESSION, "I actually don't have 100 coins with me..")
				.addNPC(npcId, HeadE.CHILD_UNSURE, "Well it looks like someone else is going to have to find the fleabag then.");
			}
			
			options.addPlayer(HeadE.ROLL_EYES, "Well, never mind, it's Fluffs' loss.")
