...
import com.rs.plugin.annotations.ItemOnItemHandler;
import com.rs.plugin.annotations.ItemOnNPCHandler;
import com.rs.plugin.annotations.LoginHandler;
...
public class GertrudesCat extends QuestOutline {
	...
	public void complete(Player player) {
		player.getSkills().addXpQuest(Skills.COOKING, 1525);
	 ...
	 */
	@NPCClickHandler(ids = { 759 })
	public static void handleFluffsOptions(NPCClickEvent e) {
	 ...
	 * @param The event to handle.
	 */
	@NPCClickHandler(ids = { 7740 })
	public static void handleShakingCrate(NPCClickEvent e) {
	 ...
	 * @param The event to handle.
	 */
	@NPCClickHandler(ids = { 780 })
	public static void handleGertrude(NPCClickEvent e) {
	 ...
	 * @param The event to handle.
	 */
	@NPCClickHandler(ids = { 781, 783 })
	public static void handleShilopWilough(NPCClickEvent e) {
	 ...
	 * @param The event to handle.
	 */
	@ItemOnItemHandler(used = 327, usedWith = { 1573 })
	public static void handleDoogleSardineCreation(ItemOnItemEvent e) {
	 ...
	 * @param The event to handle.
	 */
	@ItemOnNPCHandler(ids = { 759 })
	public static void handleItemOnNPC(ItemOnNPCEvent e) {
